...
//         opcoeText += "<input type='radio' name='atirbuto' value='" + atributo + "'>" + atributo 
//     }
//     op.innerHTML = opcoesText
// }
...
function exibirCartaMaquina() {
    ...
    for (let atributo in cartaMaquina.atributos) {
        opcoesText += "<p type='text' id='atributo' value='" + atributo +"'>" + atributo + " " + cartaMaquina.atributos[atributo] + "</p>"
    }
